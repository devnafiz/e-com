          ...
          <div class="row">
            <div class="col-md-7 col-sm-7">
              ...
              <div class="wide-banner cnt-strip">
                <div class="image"> <img class="img-responsive" src="{{ asset('upload/banner/'.$home_banner_one->image) }}" alt=""> </div>
              </div>
             @endif 
              <!-- /.wide-banner --> 
            </div>
            ...
            <div class="col-md-5 col-sm-5">
              @if($home_banner_two)
              <div class="wide-banner cnt-strip">
                <div class="image"> <img class="img-responsive" src="{{ asset('upload/banner'.$home_banner_two->image) }}" alt=""> </div>
              </div>
              @endif
              <!-- /.wide-banner --> 
            </div>
        ...
        <div class="wide-banners wow fadeInUp outer-bottom-xs">
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="wide-banner cnt-strip">
              @if($home_banner_three)
                <div class="image"> <img class="img-responsive" src="{{ asset('upload/banner/'.$home_banner_three->image) }}" alt=""> </div>
                <div class="strip strip-text">
                  <div class="strip-inner">
                    <h2 class="text-right">{{$home_banner_three->name}}<br>
