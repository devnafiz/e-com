  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        <li class='active'>{{ $item->brand_name_en }}</li>
        @endforeach
...
<div class="body-content outer-top-xs">
    ...
    @endforeach              
      ...
      <div class='col-md-9'> 
        ...
        <div id="category" class="category-carousel hidden-xs">
          <div class="item">
            @if($brand_banner)
            <div class="image"> <img src="{{ asset('upload/banner/'.$brand_banner->image) }}" alt="" class="img-responsive"> </div>
 ...
 <span class="badge badge-danger" style="background: #808080">{{ $item->brand_name_en }} </span>
        @endforeach
